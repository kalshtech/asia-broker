                        ...
                        <div className={"flex h-full flex-1 flex-col"}>
                            <div className={"flex flex-col pb-20 pt-20 h-full lg:pt-[280px]"}>
                                ...
                                <div className={"text-center mt-10"}>
                                    <Link href={"/"} className={"text-white mx-auto justify-center flex underline"}>
                                        { t("row.1.link") }
                    ...
                    <div className={"bg-[url('/images/home/communitybg2.png')] bg-cover bg-center bg-no-repeat p-6 h-full"}>
                        <div className={"flex flex-1 h-full flex-col"}>
                            <div className={"flex-col flex h-full justify-center items-center"}>
                                ...
                                <Typography variant={"muted"} className={"!text-white text-center max-w-3xl mt-6"}>
                            ...
                            <div className={"mt-auto flex justify-center"}>
                                <Typography variant={"muted"} className={"!text-white text-center text-xs max-w-md mt-5 roboto"}>
                                    { t("row.2.prompt") }
                                </Typography>
                            </div>
                        </div>
