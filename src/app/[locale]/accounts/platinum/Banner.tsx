...
const Banner =  () => {
    ...
    return (
        <section className={"bg-[url(/images/accounts/classic-banner.png)] bg-center bg-cover p-4 lg:p-30 h-108 lg:h-[632px]"}>
            <motion.div
                variants={fadeInUp}
                initial="hidden"
                whileInView="visible"
            ...
            >
                <Typography
                    variant={"h1"}
                    className={"font-medium !text-white !bg-gradient-to-b !from-[#FFF9F4] !to-[#D0B89F] !bg-clip-text !text-transparent"}
                >
                    {t("title")}
                </Typography>
            ...
            <div className={"mt-16"}>
                ...
                <Button className={"ml-4 px-8 h-10 bg-transparent hover:bg-transparent rounded-full border border-white"}>
                    { t("support") }
                </Button>
            </div>
        </section>
