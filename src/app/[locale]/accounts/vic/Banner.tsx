...
const Banner = () => {
    ...
    return (
        <section className={"bg-[url(/images/accounts/vic-banner-mobile.png)] xl:bg-[url(/images/accounts/vic-banner.png)] bg-center bg-cover h-112 lg:h-124 xl:h-[632px] py-4 xl:py-30"}>
            <Container>
                <TitleReveal
                    title={t("title")}
