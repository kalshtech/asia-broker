...
export default async function Page() {
    const t = await getTranslations("Articles.beginner.trading-mechanism");
    const sections = [
        {
        ...
        },
        {
            ...
            content: (
                <div>
                    <Typography>{t("section3.desc")}</Typography>
                    <ul className="mt-4 pl-4 list-disc space-y-1">
                        <li>
                            { t("section3.ul.li1") }
                        </li>
                        <li>
                    ...
                    <ul className="list-none mt-4 space-y-1">
                        <li>
                            ...
                            <ul className={"list-disc pl-4 mt-2 space-y-1"}>
                                ...
                                <li>
                                    <div>{t("section5.ul.li1-text3")}</div>
                                </li>
                            </ul>
                        </li>
                        <li className={"mt-4"}>
