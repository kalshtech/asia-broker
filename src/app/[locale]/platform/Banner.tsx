...
const Banner = () => {
    ...
    return (
        <section className={"bg-[url(/images/platform/banner-background.png)] bg-cover bg-center px-4 pt-4 pb-4 lg:px-30 lg:pt-30 lg:pb-12"}>
            <motion.div
                variants={fadeInUp}
                initial="hidden"
                whileInView="visible"
            ...
            >
                ...
                <Typography
                    variant={"h1"}
                    className={"font-medium text-center !text-white mt-2"}
                >
                    {t("title2")}
                </Typography>
                <Typography
            ...
            <div className={"flex justify-center mt-10"}>
                <img src="/images/platform/logo&mt5.png" className={"w-[260px] "} alt="logo&mt5" title={"logo&mt5"}/>
            </div>
